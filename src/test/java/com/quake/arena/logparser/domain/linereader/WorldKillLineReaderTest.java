...
public class WorldKillLineReaderTest {
    ...
    private WorldKillLineReader worldKillLineReader;

    @BeforeEach
    public void setUp() {
        worldKillLineReader = new WorldKillLineReader();
    }

    @Test
    public void testReadShouldIncrementPlayerCountBecauseThisIsALineAboutPlayerKilling() {
        worldKillLineReader.read(WORLD_KILL, fakeGameManager);
    ...
    public void testReadShouldNotIncrementPlayerCountBecauseThisIsNotALineAboutPlayerKilling() {
        worldKillLineReader.read(PLAYER_KILL, fakeGameManager);
